...
(function() {
  ...
  (function() {
    var DraggableObject, GoogleApiMock, MapObject, MockInfoWindow, PositionObject, VisibleObject, capitalize, getCircle, getLatLng, getMVCArray, getMap, getMarker, getPolyline;
    ...
    return angular.module('uiGmapgoogle-maps.mocks', ['uiGmapgoogle-maps']).factory('GoogleApiMock', function() {
      return GoogleApiMock;
    });
  })();
